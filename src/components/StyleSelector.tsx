...
const STYLE_VISUALS: Record<StyleId, StyleVisual> = {
  ...
  ghibli:           { gradient: 'from-emerald-400/60 via-teal-500/40 to-[#0F1115]',   accent: '#34d399' },
  oil_painting:     { gradient: 'from-amber-700/60 via-yellow-800/40 to-[#0F1115]',   accent: '#b45309' },
  pixel_art:        { gradient: 'from-lime-500/60 via-green-600/40 to-[#0F1115]',     accent: '#84cc16' },
  pop_art:          { gradient: 'from-fuchsia-500/60 via-pink-600/40 to-[#0F1115]',   accent: '#e879f9' },
  pencil_sketch:    { gradient: 'from-stone-400/60 via-gray-500/40 to-[#0F1115]',     accent: '#a8a29e' },
  van_gogh:         { gradient: 'from-yellow-500/60 via-orange-600/40 to-[#0F1115]',  accent: '#eab308' },
  lego_figure:      { gradient: 'from-red-500/60 via-yellow-500/40 to-[#0F1115]',     accent: '#ef4444' },
  action_figure:    { gradient: 'from-blue-600/60 via-indigo-700/40 to-[#0F1115]',    accent: '#3b82f6' },
  claymation:       { gradient: 'from-orange-400/60 via-amber-500/40 to-[#0F1115]',   accent: '#fb923c' },
  sumi_e:           { gradient: 'from-zinc-500/50 via-neutral-600/30 to-[#0F1115]',   accent: '#a1a1aa' },
  dark_fantasy:     { gradient: 'from-purple-900/60 via-violet-900/40 to-[#0F1115]',  accent: '#7c3aed' },
  kpop_idol:        { gradient: 'from-rose-400/60 via-pink-500/40 to-[#0F1115]',      accent: '#fb7185' },
  neon_portrait:    { gradient: 'from-fuchsia-600/60 via-purple-700/40 to-[#0F1115]', accent: '#c026d3' },
  vintage_film:     { gradient: 'from-amber-600/60 via-orange-700/40 to-[#0F1115]',   accent: '#d97706' },
  ukiyo_e:          { gradient: 'from-indigo-400/60 via-blue-500/40 to-[#0F1115]',    accent: '#818cf8' },
  tarot_card:       { gradient: 'from-violet-700/60 via-purple-800/40 to-[#0F1115]',  accent: '#8b5cf6' },
  webtoon:          { gradient: 'from-sky-500/60 via-cyan-600/40 to-[#0F1115]',       accent: '#0ea5e9' },
  sticker_art:      { gradient: 'from-pink-400/60 via-rose-500/40 to-[#0F1115]',      accent: '#f472b6' },
  '3d_clay':        { gradient: 'from-orange-300/60 via-amber-400/40 to-[#0F1115]',   accent: '#fdba74' },
  impressionist:    { gradient: 'from-violet-400/60 via-purple-500/40 to-[#0F1115]',  accent: '#a78bfa' },
};
